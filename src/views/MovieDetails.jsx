...
export const MovieDetails = (props) => {
  ...
  const [movieDetailed, setMovieDetailed] = useState(movieDetail);
            ...
            <TEModalBody className="bg-body">
              <div className="grid grid-cols-8">
                <div className="col-span-2">
                  <img src={`https://www.themoviedb.org/t/p/w220_and_h330_face${movieDetailed.poster_path}`} alt={movieDetailed.title} className="rounded shadow-xl text-center place-content-center mx-auto mt-4" />
                </div>
                <div className="col-span-6">
                  ...
                  <p className="px-10 text-justify leading-[3rem]">
                    Release Date: <span className="font-bold">{new Date(movieDetailed.release_date).toLocaleDateString()}</span>
                  </p>
                  <p className="px-10 text-justify leading-[3rem]">
                    Genres: <span className="font-bold">{movieGenreDetail}</span>
                  </p>
                  <p className="px-10 text-justify leading-[3rem]">
                    {movieDetailed.overview}
                  </p>
                  <p className="px-10 text-justify leading-[3rem]">
                    Rating: <span className="font-bold">{movieDetailed.vote_average} / 10</span>
                  </p>
